...
const CAPACIDADES = {
  ...
  'agendarCompactacao': 'fila de compactação', 'retomarCompactacoes': 'retomada ao abrir', 'tentativas': 'limite de tentativas do vídeo', 'guardarCopiaNoCelular': 'cópia no celular (Download) do que a câmera do app tira',

...
const CAPACIDADES = {
  ...
  'registroDeAmb': 'anotação escrita também vence a lápide (junção)', 'marcarRemovidoEm': 'lápide gravada no estado certo', 'ladosExpostos': 'lados de fora da casa por posição (geminada)', 'reconciliarFachadas': 'nível Fachadas da casa e do prédio', 'configurarGeminadas': 'casas geminadas (fluxo de posições)', 'lerQuantidade': 'campo de quantidade que recusa número de apartamento e absurdo', 'planoPredio': 'conferência e resumo do prédio antes de criar', 'comReversao': 'desfaz na memória o que não coube', 'id="predioResumo"': 'resumo ao vivo do prédio',
